...
int last_x;
int last_y;
char panel[1000][1000];

void up(int spaces);
void down(int spaces);
void left(int spaces);
void right(int spaces);

void draw_wire(std::map<char, int>& wire);
